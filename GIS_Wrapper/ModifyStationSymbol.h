...
class GIS_WRAPPER_EXPORT_IMPORT CModifyStationSymbol :
	public ManualDraw
{
	Q_OBJECT
public:
	CModifyStationSymbol(void);
	virtual ~CModifyStationSymbol(void);
...
private:
	...
	QVector<StationValues>* m_stationvalueArray;
	
signals:	
	 void IdentiferEnd(SymbolPoint *pPickObj,int index);
};
