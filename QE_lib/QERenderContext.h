...
public:
    ...
    inline void RenderWindow(QOpenGLWidget* pW){m_pCurrentWindows = pW;}
    inline QOpenGLWidget* RenderWindow(){return m_pCurrentWindows;}
...
private:
    QOpenGLWidget* m_pCurrentWindows;
